...
| Package | `maat` |
| Layer | `models` |
| Source path | `models/maat` |
| Functions detected | `4` |

## Function Inventory

- [convert.samples.MAAT](#function-convertsamplesmaat)
- [met2model.MAAT](#function-met2modelmaat)
- [model2netcdf.MAAT](#function-model2netcdfmaat)
- [write.config.MAAT](#function-writeconfigmaat)

## Function: convert.samples.MAAT
